...
CONFIGURATION_FILE_PATH = 'puzzlebox_bloom_configuration.ini'
...
#DEFAULT_HELP_URL = 'path://docs/html/plugin-help-jigsaw/Help_–_Puzzlebox_Jigsaw.html'
...
BLOOM_POSITION_INCREMENT = 0.4
BLOOM_POSITION_DECREMENT = 1

BLOOM_COLOR_INCREMENT = 1
BLOOM_COLOR_DECREMENT = 2

#BLOOM_SET_COLOR_CONNECT = None # Disable
BLOOM_SET_COLOR_CONNECT = [255, 255, 255] # White
#BLOOM_SET_COLOR_DISCONNECT = None # Disable
BLOOM_SET_COLOR_DISCONNECT = [0, 0, 0] # Black (Off)
...
DEFAULT_EEG_HELP_URL = 'http://jigsaw.puzzlebox.io/tracker/wiki/EEG#functions'
...
if os.path.exists(CONFIGURATION_FILE_PATH):
	...
	for line in file.readlines():
		...
		try:
			...
			if DEBUG:
				print "Error recognizing Puzzlebox Bloom configuration option:",
				print line
