...
if configuration.ENABLE_PYSIDE:
	try:
		...
		print "INFO: [Bloom:bloom-gui] Using PySide module"

if not configuration.ENABLE_PYSIDE:
	print "INFO: [Bloom:bloom-gui] Using PyQt4 module"
	from PyQt4 import QtCore, QtGui, QtNetwork


import Puzzlebox.Bloom.Interface as interface
...
if __name__ == '__main__':
	...
	QtGui.QApplication.setApplicationName('puzzlebox-bloom')
	
	window = interface.puzzlebox_bloom_interface(log, \
	                                             #server=server, \
	                                              DEBUG=DEBUG)
